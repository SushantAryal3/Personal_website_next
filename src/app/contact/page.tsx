      ...
      <div className="lg:grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        <div>
          ...
          <ul className="flex mt-12 space-x-4">
            <li className="bg-blue-700 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="javascript:void(0)">
                <FacebookIcon />
              </a>
            </li>
            <li className="bg-[#000000] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <a href="javascript:void(0)">
                <GithubIcon />
              </a>
            </li>

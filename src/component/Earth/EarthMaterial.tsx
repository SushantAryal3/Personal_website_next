...
import NightLight from "./textures/nightLight.jpg";
import Clouds from "./textures/clouds.jpg";
...
function getEarthMat(sunDirection = defaultSunDirection) {
  ...
  const map = useLoader(THREE.TextureLoader, EarthImage.src);
  const nightMap = useLoader(THREE.TextureLoader, NightLight.src);
  const cloudsMap = useLoader(THREE.TextureLoader, Clouds.src);

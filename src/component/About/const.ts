...
// import tensor from "./svg/tensorflow.svg";
import nodejs from "./svg/nodejs.svg";
import arcgis from "./svg/arcgis.png";
// Country
import Estonia from "./svg/EstoniaFlag.svg";
import Nepal from "./svg/NepalFlag.svg";
import Netherland from "./svg/NetherlandsFlag.svg";
import France from "./svg/FranceFlag.svg";
import UK from "./svg/UKFlag.svg";
import Sweden from "./svg/SwedenFlag.svg";
import Norway from "./svg/NorwayFlag.svg";
import Germany from "./svg/GermanyFlag.svg";
import Finland from "./svg/FinlandFlag.svg";
